...
static const unsigned int MAX_OPCODE = OP_NICK_CREATE;  // ObiDoge: Rialto
...
public:
    ...
    // ObiDoge: Hive: Check if script is a Bee Creation script and optionally get the honey scriptPubKey in scriptPubKeyHoney
