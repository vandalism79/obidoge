...
// ObiDoge: Rialto: A Rialto message, sent in response to a getdata request.
...
enum ServiceFlags : uint64_t {
    ...
    // ObiDoge: Rialto: NODE_RIALTO means the node supports propagation of Rialto messages
    NODE_RIALTO = (1 << 5),
...
enum GetDataMsg
{
    ...
    MSG_RIALTO = 5, // ObiDoge: Rialto message
};
