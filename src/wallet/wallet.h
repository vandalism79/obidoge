...
#include <consensus/params.h>   // ObiDoge: Hive
...
extern bool fWalletUnlockWithoutTransactions;  // ObiDoge: Hive: Unlock for hive mining purposes only.

static const unsigned int DEFAULT_KEYPOOL_SIZE = 1000;
//! -paytxfee default
static const CAmount DEFAULT_TRANSACTION_FEE = 0;
//! -fallbackfee default
static const CAmount DEFAULT_FALLBACK_FEE = 2000000 / COIN_SCALE / 10;          // ObiDoge: 10X cheaper fees. Note these constants must also account for the 10X coinscale.
//! -m_discard_rate default
static const CAmount DEFAULT_DISCARD_FEE = 10000 / COIN_SCALE / 10;             // ObiDoge: 10X cheaper fees. Note these constants must also account for the 10X coinscale.
//! -mintxfee default
static const CAmount DEFAULT_TRANSACTION_MINFEE = 100000 / COIN_SCALE / 10;     // ObiDoge: 10X cheaper fees. Note these constants must also account for the 10X coinscale.
//! minimum recommended increment for BIP 125 replacement txs
static const CAmount WALLET_INCREMENTAL_RELAY_FEE = 5000 / COIN_SCALE / 10;     // ObiDoge: 10X cheaper fees. Note these constants must also account for the 10X coinscale.
...
public:
    ...
    bool IsHiveCoinBase() const { return tx->IsHiveCoinBase(); }    // ObiDoge: Hive

    // ObiDoge: Hive: Check if this transaction is a Bee Creation Transaction
...
// ObiDoge: Hive: BCT results struct
...
// ObiDoge: Hive: Mining optimisations: Bee range structure
struct CBeeRange
{
    std::string txid;
    std::string honeyAddress;
...
public:
    ...
    // ObiDoge: Hive: Create a BCT to gestate given number of bees
    ...
    // ObiDoge: Hive: Return info for a single BCT known by this wallet, optionally scanning for blocks minted by bees from this BCT
    ...
    // ObiDoge: Hive: Return all BCTs known by this wallet, optionally including dead bees and optionally scanning for blocks minted by bees from each BCT
    ...
    // ObiDoge: Rialto: Create an NCT to register a given nickname
