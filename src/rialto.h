// Copyright (c) 2026 The ObiDoge Core developers
...
/*
ObiDoge: Rialto: End-to-end encrypted chat.
...
Rialto messaging benefits from the robust OBD P2P network and are propogated through the
