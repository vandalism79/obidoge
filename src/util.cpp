...
const char * const BITCOIN_CONF_FILENAME = "obidoge.conf";
const char * const BITCOIN_PID_FILENAME = "obidoge.pid";
...
const CLogCategoryDesc LogCategories[] =
{
    ...
    {BCLog::HIVE, "hive"},  // ObiDoge: Hive
    {BCLog::MINOTAURX, "minotaurx"},  // ObiDoge: MinotaurX+Hive1.2
    {BCLog::RIALTO, "rialto"},        // ObiDoge: Rialto
    {BCLog::ALL, "1"},
    {BCLog::ALL, "all"},
};
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "ObiDoge";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/ObiDoge";
#else
    // Unix
    return pathRet / ".obidoge";
#endif
#endif
}
...
// ObiDoge: Hive: Mining Optimisations: Return number of virt cores
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // ObiDoge: Check for untranslated substitution to make sure Litecion Core copyright is not removed by accident
