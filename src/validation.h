...
class CChainParams;
class CCoinsViewDB;
class CRialtoWhitePagesDB;    // ObiDoge: Rialto messaging DB
class CInv;
class CConnman;
class CScriptCheck;
...
static const unsigned int DEFAULT_MIN_RELAY_TX_FEE = 100000 / COIN_SCALE / 10; 	    // ObiDoge: Lowered fees
//! -maxtxfee default
static const CAmount DEFAULT_TRANSACTION_MAXFEE = 0.1 * COIN * COIN_SCALE;       	// ObiDoge: Account for coin scale
//! Discourage users to set fees higher than this amount (in satoshis) per kB
static const CAmount HIGH_TX_FEE_PER_KB = 0.01 * COIN * COIN_SCALE;              	// ObiDoge: Account for coin scale
...
static const bool DEFAULT_RIALTO_SUPPORT = false; // ObiDoge: Rialto disabled by default
...
CAmount GetBeeCost(int nHeight, const Consensus::Params& consensusParams);  // ObiDoge: Hive: Get the cost of a bee at given height
...
// ObiDoge: Rialto: Helpers to provide access to the white pages instance)
...
// ObiDoge: Rialto: Global variable that points to the active global whitepages DB (protected by cs_main)
extern std::unique_ptr<CRialtoWhitePagesDB> pwhitepages;

// ObiDoge: Rialto: Global variable that points to the active DB of our nicks (protected by cs_main)
extern std::unique_ptr<CRialtoWhitePagesDB> pmynicks;

// ObiDoge: Rialto: Global variable that points to the active DB of blocked nicks (protected by cs_main)
