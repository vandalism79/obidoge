...
public:
    ...
    // ObiDoge: Hive: Check if this transaction is a Hivemined coinbase transaction
    ...
    // ObiDoge: Hive: Check if this transaction is a Bee Creation Transaction, and if so return the total bee fee paid via beeFeePaid and honey scriptPubKey via scriptPubKeyHoney
    ...
    // ObiDoge: Rialto: Check if this transaction is a valid nick creation transaction, and optionally extract the nick and pubkey
