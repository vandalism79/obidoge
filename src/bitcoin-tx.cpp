...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s obidoge-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  obidoge-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded OBD transaction") + "\n" +
              "  obidoge-tx [options] -create [commands]   " + _("Create hex-encoded OBD transaction") + "\n" +
              "\n";
