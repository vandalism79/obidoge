...
* obidoge.conf: contains configuration settings for obidoged or obidoge-qt
* obidoged.pid: stores the process id of obidoged while running
...
* debug.log: contains debug information and general logging generated by obidoged or obidoge-qt
